  ...
  return (
    <section className="w-[47%] pt-24">
        ...
        <div className="pl-[18px]">
          ...
          <p className="mb-8">{`By partnering with [Your Mentorship Platform Name], you'll be contributing to the future of tech by shaping the next generation of industry leaders. We are eager to explore partnership opportunities that align with our mission and values, and we look forward to collaborating with organizations that share our vision.`}</p>
